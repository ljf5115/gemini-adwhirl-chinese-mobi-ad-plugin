...
public class GmAdWhirlEventHandler implements AdWhirlInterface,
	...
	public enum GmEventADType {
		// domestic
		vpon, mobwin, domob, waps, adchina, smartmad, airad, appmedia, vpontw, wqmobile, adwo, lmmob, winad, youmi, wiyun, baidu, zhidian, dipai, wooboo, anji, appjoy, casee, dianru, dianjin,
		// international
		tapjoy, mobfox,
	};
	...
	private synchronized void createEventAdapter(GmEventADType adType)
		...
		case anji:
			...
			break;
		case appjoy:
			mAdapter = new GmAdWhirlEventAdapter_cn_appjoy(adLayout, null);
			break;
		case appmedia:
		...
		case baidu:
			...
			break;
		case casee:
			mAdapter = new GmAdWhirlEventAdapter_cn_casee(adLayout, null);
			break;
		case dipai:
		...
		case waps:
			...
			break;
		case winad:
			mAdapter = new GmAdWhirlEventAdapter_cn_winad(adLayout, null);
			break;
		case wiyun:
