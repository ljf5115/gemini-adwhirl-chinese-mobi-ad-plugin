...
public class AdWhirlUtil {
	...
	public static final int CONST_INT_ADLANGUAGE_UNKNOWN = 0x00;
	public static final int CONST_INT_ADLANGUAGE_ENGLISH = 0x01;
	public static final int CONST_INT_ADLANGUAGE_CHINESE = 0x02;
	public static final int CONST_INT_ADLANGUAGE_ALL = CONST_INT_ADLANGUAGE_ENGLISH
			| CONST_INT_ADLANGUAGE_CHINESE;
	...
	public static int getContextLanguage(Context context) {
		int ret = CONST_INT_ADLANGUAGE_ALL;

		if (context != null) {
			try {
				String langStr = context.getResources().getConfiguration().locale
						.getLanguage().toLowerCase();
				if (langStr.contains("zh")) {
					ret = CONST_INT_ADLANGUAGE_CHINESE;
				} else {
					ret = CONST_INT_ADLANGUAGE_ENGLISH;
				}
			} catch (Exception e) {
			}
		}
	...
	public static int getADSupportLangSet(int type) {
		int ret = CONST_INT_ADLANGUAGE_UNKNOWN;
		switch (type) {
		case NETWORK_TYPE_ADMOB:
		case NETWORK_TYPE_ADSENSE:
			ret = CONST_INT_ADLANGUAGE_ALL;
			break;
		case NETWORK_TYPE_JUMPTAP:
		case NETWORK_TYPE_VIDEOEGG:
		case NETWORK_TYPE_MEDIALETS:
		case NETWORK_TYPE_LIVERAIL:
		case NETWORK_TYPE_MILLENNIAL:
		case NETWORK_TYPE_GREYSTRIP:
		case NETWORK_TYPE_QUATTRO:
		case NETWORK_TYPE_MOBCLIX:
		case NETWORK_TYPE_MDOTM:
		case NETWORK_TYPE_4THSCREEN:
		case NETWORK_TYPE_DOUBLECLICK:
		case NETWORK_TYPE_INMOBI:
		case NETWORK_TYPE_ZESTADZ:
		case NETWORK_TYPE_ONERIOT:
			ret = CONST_INT_ADLANGUAGE_ENGLISH;
			break;
		case NETWORK_TYPE_CUSTOM:
		case NETWORK_TYPE_ADWHIRL:
		case NETWORK_TYPE_GENERIC:
		case NETWORK_TYPE_EVENT:
			ret = CONST_INT_ADLANGUAGE_ALL;
			break;
		}
		return ret;
